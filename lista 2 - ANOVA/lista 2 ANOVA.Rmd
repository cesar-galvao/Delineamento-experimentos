...
Para o primeiro, foi observado `r resultados_tukey/10`% de ocorrência de erro tipo I. Para o segundo foi observado `r resultados_fisher`% e para o terceiro `r resultados_fisher_bonferroni`%. \
